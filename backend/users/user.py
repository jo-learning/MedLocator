...
class User:
    def __init__(self, id, name, role, email, location, hashed_password, verified, isAdmin):
        self.id = id
        self.name = name
        self.role = role
        self.email = email
    ...
    def from_db_row(cls, db_row):
        id, name, role, email, location, hashed_password, verified, isAdmin = db_row
        # return cls(id, LanguageString.from_id(name), role, email, hashed_password.encode())
        return cls(id, name, role, email, location, hashed_password.encode(), verified, isAdmin)
